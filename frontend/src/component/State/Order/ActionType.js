...
export const CREATE_ORDER_WITH_PAYMENT_REQUEST = "CREATE_ORDER_WITH_PAYMENT_REQUEST";
export const CREATE_ORDER_WITH_PAYMENT_SUCCESS = "CREATE_ORDER_WITH_PAYMENT_SUCCESS";
export const CREATE_ORDER_WITH_PAYMENT_FAILURE = "CREATE_ORDER_WITH_PAYMENT_FAILURE";
