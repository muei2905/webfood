    ...
    <div>
      <Card className='m-2 w-[18rem]'>
        ...
        <div className="p-4 textPart lg:flex w-full justify-between">
            ...
            <div onClick={handleAddToFavarite}>
                <IconButton>{isPresentInFavorites(auth.favorites, item)?<FavoriteIcon/>:<FavoriteBorderIcon/>}</IconButton>
            </div>
        </div>
      </Card>
    </div>
